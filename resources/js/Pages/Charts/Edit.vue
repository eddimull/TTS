<template>
    <breeze-authenticated-layout>
        <template #header>
            ...
            >
                <Link href="/charts"> Edit Chart </Link> ::
                {{ chartData.title }}
            </h2>
        </template>
            ...
            <div class="space-y-4">
                <div class="flex flex-col gap-4">
                    <div class="flex flex-col">
                        <label for="name" class="mb-2">Upload Name</label>
                        <InputText
                            id="name"
                    ...
                    <div class="flex flex-col">
                        <label for="name" class="mb-2">Preview</label>
                        <div class="flex">
                            <div class="max-w-md py-4 mx-auto truncate">
                                ...
                                <div v-else>Unable to display file</div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex flex-col space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div class="flex items-center space-x-2">
                            <label for="public" class="text-sm font-medium"
                                >Public</label
                            >
                            <Checkbox
