    ...
    <div class="min-w-full max-w-7xl mx-auto sm:px-6 lg:px-8 background-white-400">
      ...
      <div id="advance">
        ...
        <table class="min-w-full bg-white m-5 rounded border border-2">
          <tr class="min-w-full text-center border border-2 px-4 py-2 text-black-600 font-large">
            <td
              class="border border-black border-2 px-4"
              colspan="3"
            >
          ...
          <tr>
            <td class="border border-black border-2 px-4 py-2 w-1/6 bg-green-100">
              Date: <br>{{ formatDate(event.event_time) }}
            </td>
