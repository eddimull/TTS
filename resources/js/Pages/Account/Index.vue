                      ...
                      <div class="bg-white rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2">
                        ...
                        <div class="-mx-3 md:flex mb-6">
                          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input v-model="form.name" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3" id="grid-first-name" type="text" placeholder="Jane">
                          ...
                          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input v-model="form.email" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3" id="grid-first-name" type="email" placeholder="user@domain.com">
                        ...
                        <div class="-mx-3 md:flex mb-6">
                          <div class="md:w-full px-3">
                            ...
                            <input v-model="form.password" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3" id="grid-password" type="password" placeholder="******************">
                          ...
                          <div class="-mx-3 md:flex mb-6">
                              ...
                              <input v-model="form.address1" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3" id="address1" type="text" placeholder="">
                              ...
                              <input v-model="form.Address2" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3" id="address2" type="text" placeholder="">
                          ...
                          <div class="-mx-3 md:flex mb-6">
                              ...
                              <div class="relative">
                                  <select v-model="form.country"  @change="filterStates" class="block appearance-none w-full bg-grey-lighter border border-grey-lighter text-grey-darker py-3 px-4 pr-8 rounded" id="grid-state">
