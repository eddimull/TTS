        ...
        <Stepper value="1" :linear="true">
            ...
            <StepPanels>
                ...
                <StepPanel v-slot="{ activateCallback }" value="2">
                    <div class="flex flex-col h-48">
                        <div
                            class="border-2 border-dashed border-surface-200 dark:border-surface-700 rounded bg-surface-50 dark:bg-surface-950 flex-auto flex flex-col justify-center items-center font-medium p-4"
                        >
                            <p class="mb-2">Please select a recipient:</p>
                            <select
                                v-model="selectedContactId"
                                class="w-full p-2 border rounded dark:bg-slate-800 mb-4"
                            >
                                <option
                    ...
                    <div class="flex pt-6 justify-between">
                        ...
                        <Button
                            ...
                            iconPos="right"
                            @click="
                                handleNextFromSelectRecipient(activateCallback)
                            "
                        />
                    </div>
                </StepPanel>
                ...
                <StepPanel v-slot="{ activateCallback }" value="3">
                    <div class="flex flex-col h-48">
                        <div
                            class="border-2 p-4 border-dashed border-surface-200 dark:border-surface-700 rounded bg-surface-50 dark:bg-surface-950 flex-auto flex justify-center items-center font-medium"
                        >
                            <div v-if="sending" class="flex-col">
