...
describe("TimePicker", () => {
    it("should update time when Next Hour is clicked", async () => {
        const timeString = DateTime.now().toFormat('yyyy-MM-dd 12:00:00').toString();
        const timeStringPlusOneHour = DateTime.now().plus({hours: 1}).toFormat('yyyy-MM-dd 13:00:00').toString();
