...
use App\Handler\PandadocSignature;
...
return [
    'configs' => [
        [
             ...
             */
            'signing_secret' => env('PANDADOC_WEBHOOK_SECRET'),
             ...
             */
            'signature_validator' => PandadocSignature::class,
             ...
             */
            'process_webhook_job' => \App\Jobs\ProcessPandadocWebhookJob::class,
        ],
    ],
